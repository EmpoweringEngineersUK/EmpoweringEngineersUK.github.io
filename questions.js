...
const questions = [
    ...
    { catCode: "Intro", catLabel: "Introduction", mode: "All", text: "If you had to pick just one project to showcase your competence, which one would it be and why?" },
    ...
    { catCode: "A1", catLabel: "A1: Knowledge", mode: "All", text: "How do you identify gaps in your technical knowledge, and what specific steps do you take to close them?" },
    ...
    { catCode: "A1", catLabel: "A1: Knowledge", mode: "All", text: "Describe a situation where you had to research a technical topic deeply. What sources did you use?" },
    ...
    { catCode: "A1", catLabel: "A1: Knowledge", mode: "IEng", text: "Give an example of how you used your knowledge of engineering principles to diagnose a fault." },
    { catCode: "A1", catLabel: "A1: Knowledge", mode: "All", text: "How do you validate that the technical information you are using is current and accurate?" },
    { catCode: "A1", catLabel: "A1: Knowledge", mode: "CEng", text: "Describe a complex system you analyzed. How did you break it down into manageable theoretical components?" },
    ...
    { catCode: "A2", catLabel: "A2: Application", mode: "All", text: "What was the most technically challenging problem you have faced, and how did you resolve it?" },
    ...
    { catCode: "A2", catLabel: "A2: Application", mode: "All", text: "How do you use evidence-based approaches to solve root cause issues?" },
    ...
    { catCode: "A2", catLabel: "A2: Application", mode: "All", text: "How do you analyze failure data to prevent recurrence?" },
    { catCode: "A2", catLabel: "A2: Application", mode: "CEng", text: "Discuss a time you applied a technology from a different industry to solve a problem in your own." },

    // B1
    { catCode: "B1", catLabel: "B1: Identify/Select", mode: "All", text: "How do you go about creating a technical specification for a new project?" },
    ...
    { catCode: "B1", catLabel: "B1: Identify/Select", mode: "All", text: "Walk us through your decision-making process when selecting materials or components." },
    ...
    { catCode: "B1", catLabel: "B1: Identify/Select", mode: "All", text: "Can you give an example of how you identified the critical constraints (budget, space, time) early in a project?" },
    ...
    { catCode: "B1", catLabel: "B1: Identify/Select", mode: "All", text: "How do you ensure that safety and environmental requirements are captured in your initial specs?" },
    ...
    { catCode: "B2", catLabel: "B2: Design", mode: "All", text: "Describe a specific contribution you made to a design. How did you validate your calculations?" },
    ...
    { catCode: "B2", catLabel: "B2: Design", mode: "All", text: "How do you identify and mitigate risks in your design process?" },
    ...
    { catCode: "B2", catLabel: "B2: Design", mode: "All", text: "Walk us through a time you used software (CAD/FEA) to verify a solution. How did you know the results were correct?" },
    { catCode: "B2", catLabel: "B2: Design", mode: "CEng", text: "How do you manage design interfaces between different engineering disciplines?" },

    // B3
    { catCode: "B3", catLabel: "B3: Implementation", mode: "All", text: "How complicated was the implementation of your recent project? What were the main risks?" },
    ...
    { catCode: "B3", catLabel: "B3: Implementation", mode: "All", text: "How did you evaluate the success of a project after it was completed? Did it meet the KPIs?" },
    ...
    { catCode: "B3", catLabel: "B3: Implementation", mode: "All", text: "What lessons learned did you capture from your last implementation, and how have you shared them?" },
    ...
    { catCode: "B3", catLabel: "B3: Implementation", mode: "All", text: "Tell us about a time the implementation did NOT go to plan. How did you recover?" },
    ...
    { catCode: "C1", catLabel: "C1: Planning", mode: "All", text: "How do you estimate the time and cost required for a new piece of work?" },
    ...
    { catCode: "C1", catLabel: "C1: Planning", mode: "All", text: "Describe a time you had to prioritize conflicting tasks. What criteria did you use?" },
    ...
    { catCode: "C1", catLabel: "C1: Planning", mode: "All", text: "What tools do you use to monitor project progress and budget spend?" },
    { catCode: "C1", catLabel: "C1: Planning", mode: "CEng", text: "Describe how you define the Work Breakdown Structure (WBS) for a large project." },

    // C2
    { catCode: "C2", catLabel: "C2: Management", mode: "All", text: "Tell us about a time a project deviated from the plan. How did you manage resources to recover?" },
    ...
    { catCode: "C2", catLabel: "C2: Management", mode: "All", text: "How do you ensure your project stays within budget?" },
    ...
    { catCode: "C2", catLabel: "C2: Management", mode: "All", text: "What is your approach to change management within a project?" },
    ...
    { catCode: "C2", catLabel: "C2: Management", mode: "All", text: "Describe a time you had to secure additional resources or budget mid-project." },
    ...
    { catCode: "C3", catLabel: "C3: Leadership", mode: "All", text: "How do you delegate tasks effectively? How do you ensure the person is capable?" },
    ...
    { catCode: "C3", catLabel: "C3: Leadership", mode: "All", text: "Describe a time you mentored or coached a colleague. What was the outcome?" },
    ...
    { catCode: "C3", catLabel: "C3: Leadership", mode: "All", text: "How do you identify the training needs of your team?" },
    { catCode: "C3", catLabel: "C3: Leadership", mode: "CEng", text: "Describe your leadership style. How do you adapt it for different stakeholders?" },

    // C4
    { catCode: "C4", catLabel: "C4: Quality", mode: "All", text: "How do you go about continuous improvement? Give a specific example." },
    ...
    { catCode: "C4", catLabel: "C4: Quality", mode: "All", text: "Tell us about a time you audited a process and found non-conformances." },
    ...
    { catCode: "C4", catLabel: "C4: Quality", mode: "All", text: "What Quality Management Systems (e.g., ISO 9001) do you work with?" },
    ...
    { catCode: "C4", catLabel: "C4: Quality", mode: "All", text: "How do you capture 'lessons learned' to prevent future quality issues?" },

    // D1
    { catCode: "D1", catLabel: "D1: Communication", mode: "All", text: "How do you ensure your communication method is effective for your specific audience?" },
    ...
    { catCode: "D1", catLabel: "D1: Communication", mode: "All", text: "Tell us about a time communication broke down on a project. How did you fix it?" },
    ...
    { catCode: "D1", catLabel: "D1: Communication", mode: "All", text: "Describe a time you chaired a meeting. How did you ensure clear outcomes?" },
    ...
    { catCode: "D1", catLabel: "D1: Communication", mode: "All", text: "How do you verify that your email or report has been understood correctly?" },

    // D2
    { catCode: "D2", catLabel: "D2: Persuasion", mode: "All", text: "Tell us about a proposal you put forward. How did you convince others to pursue it?" },
    ...
    { catCode: "D2", catLabel: "D2: Persuasion", mode: "All", text: "Tell us about a formal presentation you gave. How did you prepare for it?" },
    ...
    { catCode: "D2", catLabel: "D2: Persuasion", mode: "All", text: "Give an example of how you adapted your presentation style mid-flow based on the audience's reaction." },
    ...
    { catCode: "D2", catLabel: "D2: Persuasion", mode: "All", text: "What is your strategy for handling difficult questions during a presentation?" },

    // D3
    { catCode: "D3", catLabel: "D3: Interpersonal", mode: "All", text: "Can you give us an example of a conflict you resolved within your team?" },
    ...
    { catCode: "D3", catLabel: "D3: Interpersonal", mode: "All", text: "How do you build trust with a new client or team member?" },
    ...
    { catCode: "D3", catLabel: "D3: Interpersonal", mode: "All", text: "Tell us about a time you had to be diplomatic in a tense situation." },
    ...
    { catCode: "D3", catLabel: "D3: Interpersonal", mode: "All", text: "How does your behavior influence the working culture of your team?" },

    // E1
    { catCode: "E1", catLabel: "E1: Codes of Conduct", mode: "All", text: "What does your Institution's Code of Conduct mean to you personally?" },
    ...
    { catCode: "E1", catLabel: "E1: Codes of Conduct", mode: "All", text: "How do you stay updated on changes to engineering standards in your sector?" },
    ...
    { catCode: "E1", catLabel: "E1: Codes of Conduct", mode: "All", text: "How does your employer's code of conduct compare to the requirements of the Professional Body?" },
    ...
    { catCode: "E1", catLabel: "E1: Codes of Conduct", mode: "All", text: "Why is self-regulation important for the engineering profession?" },

    // E2
    { catCode: "E2", catLabel: "E2: Safety", mode: "All", text: "Can you tell us about a safety risk you identified? What actions did you take to mitigate it?" },
    ...
    { catCode: "E2", catLabel: "E2: Safety", mode: "All", text: "What is your experience with Risk Assessments (RAMS) or HAZOP studies?" },
    ...
    { catCode: "E2", catLabel: "E2: Safety", mode: "All", text: "Describe a near-miss you witnessed. How was it reported and what changed because of it?" },
    ...
    { catCode: "E2", catLabel: "E2: Safety", mode: "All", text: "How do you balance safety requirements with cost and schedule pressures?" },

    // E3
    { catCode: "E3", catLabel: "E3: Sustainability", mode: "All", text: "How did you contribute to sustainability in your recent project? Give concrete examples." },
    ...
    { catCode: "E3", catLabel: "E3: Sustainability", mode: "All", text: "How do you balance economic requirements with environmental responsibilities?" },
    ...
    { catCode: "E3", catLabel: "E3: Sustainability", mode: "All", text: "What are the key environmental challenges facing your specific industry right now?" },
    ...
    { catCode: "E3", catLabel: "E3: Sustainability", mode: "All", text: "How does your work contribute to the UN Sustainable Development Goals (SDGs)?" },

    // E4
    { catCode: "E4", catLabel: "E4: CPD", mode: "All", text: "How do you record and plan your CPD? How do you decide what to learn next?" },
    ...
    { catCode: "E4", catLabel: "E4: CPD", mode: "All", text: "Walk us through your CPD record for the last 12 months. What was the most valuable activity?" },
    ...
    { catCode: "E4", catLabel: "E4: CPD", mode: "All", text: "How do you reflect on your learning? Do you review what went well and what didn't?" },
    ...
    { catCode: "E4", catLabel: "E4: CPD", mode: "All", text: "How do you promote engineering to the next generation?" },

    // E5
    { catCode: "E5", catLabel: "E5: Ethics", mode: "All", text: "What does ethics mean to you in an engineering context? Give an example." },
    ...
    { catCode: "E5", catLabel: "E5: Ethics", mode: "All", text: "How do you ensure honesty and integrity in your reporting of data?" },
    ...
    { catCode: "E5", catLabel: "E5: Ethics", mode: "All", text: "If you made a mistake that caused a delay, would you admit it immediately? Why?" },
    ...
    { catCode: "E5", catLabel: "E5: Ethics", mode: "All", text: "How do you demonstrate the Statement of Ethical Principles (Honesty, Integrity, Respect, Rigour)?" },

    // DAP
    { catCode: "DAP", catLabel: "Development Plan", mode: "All", text: "Can you tell us about your career goals in the short, medium, and long term?" },
    ...
    { catCode: "DAP", catLabel: "Development Plan", mode: "All", text: "How will achieving professional registration influence your future career path?" },
    ...
    { catCode: "DAP", catLabel: "Development Plan", mode: "All", text: "How will you use your status to help other engineers?" },
    ...
    { catCode: "DAP", catLabel: "Development Plan", mode: "All", text: "If you could change one thing about your industry, what would it be?" },
    ...
    { catCode: "Closing", catLabel: "Closing", mode: "All", text: "That concludes the formal questions. Thank you for your time." }
];